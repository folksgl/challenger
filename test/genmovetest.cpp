...
TEST(no_blank_capture, white) {
    ...
    EXPECT_EQ(bit_to_square.at(startpos.passant_sq), "-");
...
TEST(number_of_moves_generated, startpos_white_knight) {
    ...
    leaper_generator(&startpos, not_own, knight_moves, w_knight);         // knight moves
...
TEST(number_of_moves_generated, startpos_black_knight) {
    ...
    leaper_generator(&startpos, not_own, knight_moves, b_knight);         // knight moves
...
TEST(number_of_moves_generated, startpos_white_bishop) {
    ...
    bitboard not_own = ~(startpos.maps[w_pieces]);
    slide_generator(&startpos, startpos.maps[w_bishop], not_own, &get_bishop_attacks, w_bishop);
...
TEST(number_of_moves_generated, startpos_black_bishop) {
    ...
    bitboard not_own = ~(startpos.maps[b_pieces]);
    slide_generator(&startpos, startpos.maps[b_bishop], not_own, &get_bishop_attacks, b_bishop);
...
TEST(number_of_moves_generated, startpos_white_rook) {
    ...
    bitboard not_own = ~(startpos.maps[w_pieces]);
    slide_generator(&startpos, startpos.maps[w_rook], not_own, &get_rook_attacks, w_rook);
...
TEST(number_of_moves_generated, startpos_black_rook) {
    ...
    bitboard not_own = ~(startpos.maps[b_pieces]);
    slide_generator(&startpos, startpos.maps[b_rook], not_own, &get_rook_attacks, b_rook);
...
TEST(number_of_moves_generated, startpos_white_queen) {
    ...
    bitboard not_own = ~(startpos.maps[w_pieces]);
    slide_generator(&startpos, startpos.maps[w_queen], not_own, &get_queen_attacks, w_queen);
...
TEST(number_of_moves_generated, startpos_black_queen) {
    ...
    bitboard not_own = ~(startpos.maps[b_pieces]);
    slide_generator(&startpos, startpos.maps[b_queen], not_own, &get_queen_attacks, b_queen);
...
TEST(number_of_moves_generated, startpos_white_king) {
    ...
    bitboard not_own = ~(startpos.maps[w_pieces]);
    leaper_generator(&startpos, not_own, king_moves, w_king);
...
TEST(number_of_moves_generated, startpos_black_king) {
    ...
    bitboard not_own = ~(startpos.maps[b_pieces]);
    leaper_generator(&startpos, not_own, king_moves, b_king);
...
TEST(correct_moves_generated, complex_position_3_perft_move_1) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('a', '5'));
    startpos.move("a5a4", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_2) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('a', '5'));
    startpos.move("a5a6", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_3) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4a4", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_4) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4b1", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_5) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4b2", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_6) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4b3", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_7) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4c4", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_8) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4d4", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_9) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4e4", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_10) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('b', '4'));
    startpos.move("b4f4", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_11) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('e', '2'));
    startpos.move("e2e3", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_12) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('e', '2'));
    startpos.move("e2e4", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_13) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('g', '2'));
    startpos.move("g2g3", moving_piece);
...
TEST(correct_moves_generated, complex_position_3_perft_move_14) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('g', '2'));
    startpos.move("g2g4", moving_piece);
...
TEST(correct_moves_generated, castling_rights_correct_after_w_kingside) {
    ...
    EXPECT_EQ(startpos.moves[5].w_kingside_castle,  false);
    EXPECT_EQ(startpos.moves[5].w_queenside_castle, false);
    EXPECT_EQ(startpos.moves[5].b_kingside_castle,  true);
    EXPECT_EQ(startpos.moves[5].b_queenside_castle, true);
}
...
TEST(correct_moves_generated, castling_rights_correct_after_w_queenside) {
    ...
    EXPECT_EQ(startpos.moves[10].w_kingside_castle,  false);
    EXPECT_EQ(startpos.moves[10].w_queenside_castle, false);
    EXPECT_EQ(startpos.moves[10].b_kingside_castle,  true);
    EXPECT_EQ(startpos.moves[10].b_queenside_castle, true);
}
...
TEST(correct_number_moves_generated, king_in_check) {
    ...
    moving_piece = startpos.get_moving_piece(get_square_num('c', '3'));
    startpos.move("c3d5", moving_piece);
...
TEST(correct_number_moves_generated, random_pos_002) {
    ...
    EXPECT_EQ(startpos.is_white_move, false);
    ...
    EXPECT_EQ(startpos.passant_sq, 0);
...
TEST(correct_number_moves_generated, random_pos_003) {
    ...
    int moving_piece = startpos.get_moving_piece(get_square_num('e', '2'));
    startpos.move("e2d1", moving_piece);
    moving_piece = startpos.get_moving_piece(get_square_num('a', '6'));
    startpos.move("a6f1", moving_piece);
    moving_piece = startpos.get_moving_piece(get_square_num('e', '5'));
    startpos.move("e5f7", moving_piece);
    moving_piece = startpos.get_moving_piece(get_square_num('a', '8'));
